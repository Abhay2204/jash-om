...
export default function Contact() {
  return (
    <section id="contact" className="py-16 md:py-36 bg-[#A68966] text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 md:mb-8 text-white">Ready to <span className="underline decoration-[#D3211B] decoration-4 underline-offset-8">Optimize</span> Your Standards?</h2>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <a href="tel:9331874296" className="text-xl sm:text-2xl font-bold hover:text-[#D3211B] transition-colors tracking-tight text-white">9331874296</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <a href="mailto:debasisjashap@gmail.com" className="text-xl sm:text-2xl font-bold hover:text-[#D3211B] transition-colors tracking-tight text-white">debasisjashap@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-xl sm:text-2xl font-bold tracking-tight text-white">West Bengal, India</p>
                </div>
              </div>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="lg:col-span-7 bg-white p-6 sm:p-10 md:p-14 rounded-[32px] md:rounded-[40px] shadow-2xl"
          >
