  ...
  return (
    <section id="why-us" className="pb-24 md:pb-36 bg-[#F8FAFC]">
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        >
          <span className="text-[#F39200] font-bold tracking-[0.2em] text-xs uppercase mb-4 block">Unmatched Excellence</span>
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[#0B2D5C]">Why Choose Us?</h2>
          <div className="w-20 h-1 bg-[#F39200] mx-auto mt-6 rounded-full"></div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {reasons.map((r, i) => (
            ...
            >
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#0B2D5C]/5 flex items-center justify-center mb-8 group-hover:bg-[#F39200]/10 transition-colors">
                <r.icon className="w-7 h-7 text-[#F39200]" />
              </div>
              <h3 className="text-xl font-bold text-[#0B2D5C] group-hover:text-[#F39200] transition-colors">{r.title}</h3>
        ...
        <div className="mt-32 grid lg:grid-cols-12 gap-12 items-start">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="lg:col-span-5 bg-[#0B2D5C] p-10 md:p-14 rounded-[40px] shadow-2xl relative overflow-hidden text-white"
          >
            ...
            <div className="space-y-4 relative z-10">
              {expertise.map((e, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#F39200] flex items-center justify-center">
                    <CheckCircle className="w-4 h-4 text-[#0B2D5C]" />
                  </div>
          ...
          >
            <div className="mb-10 lg:pl-4">
              <h3 className="text-3xl font-bold text-[#0B2D5C]">Industry Coverage</h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {industries.map((ind, i) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="p-6 bg-white rounded-2xl border border-gray-100 flex flex-col items-center justify-center text-center hover:border-[#F39200]/30 hover:shadow-lg transition-all group"
                >
                  <ind.icon className="w-8 h-8 text-[#0B2D5C] group-hover:text-[#F39200] transition-colors mb-4" />
        ...
        >
          <div className="absolute top-10 left-1/2 -translate-x-1/2 text-[120px] font-serif text-[#0B2D5C]/5 select-none leading-none">"</div>
          <p className="max-w-4xl mx-auto text-2xl md:text-3xl lg:text-4xl font-bold text-[#0B2D5C] leading-tight relative z-10 italic">
            "Our commitment to international quality standards ensures that your organization not only <span className="text-[#F39200]">complies but excels</span> in the global marketplace."
          </p>
        </motion.div>
      </div>
    </section>
