      ...
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <div className="inline-flex items-center gap-4 mb-4 justify-center">
            ...
            <h2 className="text-sm font-bold text-[#F39200] uppercase tracking-widest leading-none">About Company</h2>
            <span className="w-8 h-[2px] bg-[#F39200]"></span>
          </div>
          <h3 className="text-4xl md:text-5xl font-bold tracking-tighter text-[#0B2D5C] leading-tight mt-2">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative flex justify-center items-center py-10 min-h-[400px]">
            ...
            <div className="absolute w-[320px] h-[320px] md:w-[480px] md:h-[480px] pointer-events-none">
              ...
              <div className="absolute top-[14.6%] left-[14.6%] w-12 h-12 bg-white rounded-full shadow-lg border border-gray-100 flex items-center justify-center z-20 pointer-events-auto -translate-x-1/2 -translate-y-1/2">
                 <ShieldCheck className="w-6 h-6 text-[#0B2D5C]" />
              </div>
              {/* Bottom-Left */}
              ...
              {/* Top-Right */}
              <div className="absolute top-[14.6%] right-[14.6%] w-14 h-14 bg-[#0B2D5C] rounded-full shadow-lg flex items-center justify-center z-20 pointer-events-auto translate-x-1/2 -translate-y-1/2">
                 <FileText className="w-6 h-6 text-white" />
              </div>
              {/* Bottom-Right */}
              <div className="absolute bottom-[14.6%] right-[14.6%] w-12 h-12 bg-[#F39200] rounded-full shadow-lg flex items-center justify-center z-20 pointer-events-auto translate-x-1/2 translate-y-1/2">
          ...
          <div className="flex flex-col justify-center">
            <div className="w-10 h-[3px] bg-[#F39200] mb-6"></div>
            <h4 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#0B2D5C]">
            ...
            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#0B2D5C] mt-2.5 shrink-0"></span>
            ...
            <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col gap-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                <div className="flex items-baseline gap-1 min-w-[120px]">
                  <span className="text-4xl xl:text-5xl font-black text-[#0B2D5C]">21+</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 pt-6 border-t border-gray-50">
                <div className="flex items-baseline gap-1 min-w-[120px]">
                  <span className="text-4xl xl:text-5xl font-black text-[#0B2D5C]">100%</span>
            ...
            <div className="mt-12">
              <button className="px-8 py-4 bg-[#F39200] text-white font-bold rounded-md flex items-center gap-3 hover:bg-[#0B2D5C] transition-all shadow-md">
                Learn More 
