...
export default function Founder() {
  return (
    <section id="founder" className="py-20 md:py-32 bg-[#0B2D5C] text-white">
      <div className="max-w-[1000px] mx-auto px-6 text-center flex flex-col items-center">
        <div className="relative w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-[#F39200] mb-10 shadow-2xl">
          <Image 
        ...
        <h2 className="text-sm font-bold text-[#F39200] uppercase tracking-widest">Founder&apos;s Focus</h2>
        <p className="mt-6 text-xl md:text-2xl font-bold text-white max-w-2xl">
          Ex-Quality Head (Nestlé CP) & ISO Coordinator. <br className="hidden md:block"/> <span className="text-[#F39200] font-medium">Premium category experience.</span>
        </p>
